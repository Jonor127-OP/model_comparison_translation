...
if __name__ == '__main__':
    model_path = 'output/model_transformer.pt'
    dataset_path = 'dataset/nl/seq2seq/wmt17_en_de/valid.merge_en_de.ids.gz'
    vocabulary_path = 'dataset/nl/seq2seq/wmt17_en_de/vocabulary.json'
    max_len = 200
    window_training = 0
    output_file = 'comparison_resultstransfo.txt'
